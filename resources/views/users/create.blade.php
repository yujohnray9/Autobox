...
<div class="max-w-lg">
    ...
    <div class="mockup-card p-6 space-y-5">
        ...
        <form method="POST" action="{{ route('users.store') }}" class="space-y-4">
            ...
            <div>
                <label class="block text-[10px] font-extrabold text-[var(--text-muted)] mb-1.5 uppercase tracking-widest">Password</label>
            ...
            <div>
                <label class="block text-[10px] font-extrabold text-[var(--text-muted)] mb-1.5 uppercase tracking-widest">Confirm Password</label>
